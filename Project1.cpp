...
void man(char *name)
{
    ...
    else if(strcmp(name,"read")== 0)
    {
        ...
        printf("Usage : read File _name No_Of_Bytes_To_Read\n");
    }
    else if(strcmp(name,"write")== 0)
    {
        printf("Description : Used to write into regular file\n");
        printf("Usage : write File _name\n After this enter the data that we want to write\n");
    }
    ...
    {
        printf("Description : Used to display informatiom of file\n");
        printf("Usage : stat File _name\n");
    }
    else if(strcmp(name,"fstat")== 0)
    {
        printf("Description : Used to display information of file\n");
        printf("Usage : stat File _Descriptor\n");
    }
    else if(strcmp(name,"truncate")== 0)
    {
        printf("Description : Used to remove data from file\n");
        printf("Usage : truncate File _name\n");
    }
    else if(strcmp(name,"open")== 0)
    {
        printf("Description : Used to open existing file\n");
        printf("Usage : openFile _name mode\n");
    }
    ...
    else if(strcmp(name,"Iseek")== 0)
    {
        ...
        printf("Usage : Iseek File _Name ChangeInOffset StartPoint\n");
    }
    else if(strcmp(name,"rm")== 0)
    {
        printf("Description : Used to delete the file\n");
        printf("Usage : rm File _name\n");
    }
    else
    {
...
int WriteFilw(int fd, char *arr,int isize)
{
...
int LseekFile(int fd, int size, int from)
{
    ...
    if((UFDTArr[fd].ptrfiletable->mode == READ) || (UFDTArr[fd].ptrfiletable->mode == READ + WRITE))
    {
        ...
        else if(from == END)
        {
            ...
            if(((UFDTArr[fd].ptrfiletable->readoffset) + size >size) < 0) return -1;
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Termonating the Marvellous Virtual File System\n");
                break;
            }
            else
            {
